...
*Список терминов: [Административная команда (administration command)](/#/resources/glossary?id=Административная-команда-administration-command), [Агрегация (aggregation)](/#/resources/glossary?id=Агрегация-aggregation), [Агрегатная функция (aggregation function)](/#/resources/glossary?id=Агрегатная-функция-aggregation-function), [Перекрестное соединение (cross join)](/#/resources/glossary?id=Перекрестное-соединение-cross-join), [Исключающее ИЛИ (exclusive or)](/#/resources/glossary?id=Исключающее-ИЛИ-exclusive-or), [Фильтрация (filter)](/#/resources/glossary?id=Фильтрация-filter), [Полное внешнее соединение (full outer join)](/#/resources/glossary?id=Полное-внешнее-соединение-full-outer-join), [Группа (group)](/#/resources/glossary?id=Группа-group), [База данных в памяти (in-memory database)](/#/resources/glossary?id=База-данных-в-памяти-in-memory-database), [Включающее ИЛИ (inclusive or)](/#/resources/glossary?id=Включающее-ИЛИ-inclusive-or), [Соединение (join)](/#/resources/glossary?id=Соединение-join), [Условие соединения (join condition)](/#/resources/glossary?id=Условие-соединения-join-condition), [Левое внешнее соединение (left outer join)](/#/resources/glossary?id=Левое-внешнее-соединение-left-outer-join), [Нуль (null)](/#/resources/glossary?id=Нуль-null), [Запрос](/#/resources/glossary?id=Запрос-query), [Правое внешнее соединение (right outer join)](/#/resources/glossary?id=Правое-внешнее-соединение-right-outer-join), [Трехзначная логика (ternary logic)](/#/resources/glossary?id=Трехзначная-логика-ternary-logic), [Надгробный камень (tombstone)](/#/resources/glossary?id=Надгробный-камень-tombstone)*
...
- Столбец под названием `what_where`, в котором виды и острова каждого пингвина разделены одним пробелом.
- Столбец `bill_ratio`, в котором указано соотношение длины клюва к его глубине.

...
*Псевдоним* (alias) - Альтернативное имя, временно назначаемое для таблицы или столбца.
...
# Т
*Таблица* (table) - Коллекция связанных данных в базе данных, хранящихся в колонках и строках.
...
# Ф
*Фильтрация* (filter) - Выбор записей на основе того, проходят ли они некоторый булевский тест.
